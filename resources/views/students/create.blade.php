...
@section('content')
    <div id="page-meta" data-title="Add Student" data-parent="Students">
                    ...
                    <div class="bg-yellow-100 shadow-lg rounded-lg p-4 pb-6 overflow-x-auto">
                        <div class="min-w-[1100px]">
                            <div class="grid grid-cols-2 gap-6">
                                ...
                                <div class="px-2">
                                    <label for="first_name" class="block text-gray-800 font-medium mb-2 text-lg text-left">First
                                        Name</label>
                                ...
                                <div class="px-2">
                                    <label for="last_name" class="block text-gray-800 font-medium mb-2 text-lg text-left">Last
                                        Name</label>
                                ...
                                <div class="px-2">
                                    <label for="email" class="block text-gray-800 font-medium mb-2 text-lg text-left">Email
                                        Address</label>
                                ...
                                <div class="px-2">
                                    <label for="guardian_contact"
                                        class="block text-gray-800 font-medium mb-2 text-lg text-left">Guardian Contact</label>
                                ...
                                <div class="flex justify-end px-2">
                                    <button type="submit"
                                        class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg shadow transition">
                                        Add Student
                                    </button>
                                </div>
            ...
            (function() { // IIFE Start
                ...
                function initializeStudentSectionFilter() {
                    ...
                    function filterSections() {
                        ...
                        // If the previously selected option is hidden, reset the select to placeholder
