...
@section('title', 'Batch Upload Student')
...
<div class="container mx-auto px-4">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex justify-start mt-6 mb-4">
            <a href="{{ route('students.index') }}" 
                onclick="event.preventDefault(); 
                         ...
                         loadContent('{{ route('students.index') }}', courseLink || 'Students');"
        ...
        <div class="bg-yellow-100 shadow-lg rounded-lg p-8">
            <h2 class="text-2xl font-bold gray-black-800 mb-6">Batch Upload Students</h2>

            <form id="uploadForm" action="{{ route('students.upload.process') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div class="text-left">
                    <div class="flex flex-wrap items-center gap-2">
                        ...
                        <a href="{{ asset('templates/student_template.xlsx') }}" class="text-blue-600 hover:underline break-all">
                            Download Template
                        </a>
                    </div>
                </div>
...
<div id="confirmationModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden z-50 flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-sm">
        ...
        <p class="text-sm text-gray-600 text-center mt-2">
            Are you sure you want to upload this file? This will create new student accounts.
        </p>
