...
<head>
    ...
    <title>Batch Upload Students</title>
...
<body class="bg-gray-100">
    <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg">
            <div class="p-6">
                <h2 class="text-2xl font-bold mb-4">Batch Upload Students</h2>
                ...
                <form id="uploadForm" action="{{ route('students.upload.process') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <a href="{{ asset('templates/student_template.xlsx') }}" class="text-blue-500 hover:text-blue-700">
                            Download Template
                        </a>
                    </div>
