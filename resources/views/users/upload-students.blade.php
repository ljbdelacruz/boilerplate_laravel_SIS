...
@section('content')
    <div id="page-meta" data-title="Batch Upload" data-parent="Students">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="bg-yellow-100 shadow-lg rounded-lg p-8">
                    ...
                    <form id="uploadForm" action="{{ route('students.upload.process') }}" method="POST"
                        ...
                        <div class="text-left">
                            <div class="flex flex-wrap items-center gap-2">
                                ...
                                <a href="{{ asset('templates/student_template.xlsx') }}"
        ...
        {{-- Confirmation Modal --}}
        <div id="confirmationModal" class="fixed inset-0 bg-transparent hidden z-50 flex items-center justify-center">
