...
@section("content")
    <div id="page-meta" data-title="Edit School Year" data-parent="School Years">
                ...
                <div class="bg-yellow-100 shadow-lg rounded-lg p-8">
                    ...
                    <form action="{{ route('school-years.update', $schoolYear->id) }}" method="POST">
                        ...
                        <div class="mb-4 text-left">
                            <label for="start_year" class="block text-gray-800 font-medium mb-2"
                                style="font-size: 22px;">Start Year</label>
                            <input type="number" name="start_year" id="start_year"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400"
                                min="2000" max="2099" value="{{ old('start_year', $schoolYear->start_year) }}" required>
                        </div>

                        <div class="mb-4 text-left">
                            <label for="end_year" class="block text-gray-800 font-medium mb-2" style="font-size: 22px;">End
                                Year</label>
                            <input type="number" name="end_year" id="end_year"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400"
                                min="2000" max="2099" value="{{ old('end_year', $schoolYear->end_year) }}" required>
                        </div>
