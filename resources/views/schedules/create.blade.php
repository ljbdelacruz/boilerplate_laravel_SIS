...
@section('content')
    <div id="page-meta" data-title="Add Schedule" data-parent="Schedules">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto">
                {{-- Back Button --}}
                <div class="flex justify-start mt-6 mb-4">
                    <a href="{{ route('schedules.index') }}" onclick="event.preventDefault(); 
                    ...
                    <form action="{{ route('schedules.store') }}" method="POST">
                        ...
                        <div class="mb-6 text-left">
                            ...
                            <select name="course_id" id="course_id" required
                                ...
                                <option value="{{ $course->id }}" data-grade-level="{{ $course->grade_level }}" {{ old('course_id') == $course->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-6 text-left">
                            ...
                            <select name="section_id" id="section_id" required
                                ...
                                <option value="{{ $section->id }}" data-grade-level="{{ $section->grade_level }}" {{ old('section_id') == $section->id ? 'selected' : '' }} style="display: none;">
        ...
        <script>
            ...
            function updateSectionDropdown() {
                ...
                const previouslySelectedSectionId = sectionSelect.value; // Store before resetting
                ...
                if (placeholderOption) {
                    sectionSelect.value = ""; // Select the placeholder value
                }
